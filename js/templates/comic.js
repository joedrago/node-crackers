...
(function() {
  var endZoom, fotorama, nextUrl, prevUrl, touchTimestamp, updateZoom, updateZoomPos, zoomScale, zoomScaleIndex, zoomScales, zoomX, zoomY;
  ...
  updateZoomPos = function(event) {
    ...
    return zoomY = ((t.clientY - t.target.offsetTop) / t.target.clientHeight).clamp(0, 1);
  };

  updateZoom = function() {
    var h, offX, offY, tf, w;
    w = 0;
    h = 0;
