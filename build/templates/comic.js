...
(function() {
  var Auto, altZoom, autoNext, autoPrev, autoState, autoStateOnShowEnd, endZoom, fadeIn, fadeOut, fotorama, helpShowing, kickPreloader, loadedImages, nextUrl, posClass, preloadImageCount, preloadImageCountDefault, prevUrl, spaceHeld, spaceMovedZoom, touchTimestamp, updateZoom, updateZoomPos, zoomScale, zoomScaleIndex, zoomScales, zoomToCorner, zoomX, zoomY;
...
;
  ...
  fotorama.on('fotorama:show', function(e, fotorama, extra) {
    return kickPreloader(fotorama.activeIndex);
  });
