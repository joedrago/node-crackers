...
(function() {
  var ComicGenerator, Crackers, RootGenerator, SubdirGenerator, Unpacker, cfs, constants, exec, fs, log, path, wrench;
  ...
  Crackers = (function() {
    ...
    Crackers.prototype.update = function(args) {
      var absoluteNextDir, comicDir, comicGenerator, comicName, file, filesToUnpack, i, imageDir, imageDirPieces, imageDirs, j, k, l, len, len1, len2, len3, m, nextDir, nextParent, nextParsed, parent, parsed, prevDir, relativeComicDir, rootGenerator, sawOneComic, subdir, subdirGenerator, subdirSeen, subdirs, unpackDir, unpackFile;
      ...
      for (i = k = 0, len1 = imageDirs.length; k < len1; i = ++k) {
        ...
        if (parsed.dir) {
          ...
          if (i + 1 < imageDirs.length) {
            ...
            if (nextParsed.dir) {
              ...
              if (nextParent.name && (parent.dir === nextParent.dir)) {
                ...
                nextDir = path.relative(this.rootDir, absoluteNextDir).replace(/\\/g, "/");
              }
            }
          }
          ...
          if ((nextDir.length > 0) && (comicName.length > 0)) {
            relativeComicDir = path.relative(this.rootDir, comicDir);
            if (relativeComicDir.length === 0) {
              relativeComicDir = '.';
            }
